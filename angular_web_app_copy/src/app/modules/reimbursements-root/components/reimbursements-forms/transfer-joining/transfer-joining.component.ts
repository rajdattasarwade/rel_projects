...
import { ReimbursementsDetails,AttachDoc } from '../../../utils/reimbursements.model';
...
export class TransferJoiningComponent implements OnInit {
  ...
  fxFlexColumn: number = 45;
  reimbursementType = "Transfer/Joining Exp";
  sapCode: any;
  typeText: any;
  form:FormArray;
  ...
  createGroup(counter) {
    this.childFormGroup = new FormGroup({
      ...
      requestedAmount: new FormControl('', [Validators.required,Validators.max(9999999999999)]),
      remarks: new FormControl('',[Validators.maxLength(80)]),
  ...
  editGroup(editObj) {
    ...
    this.childFormGroup = new FormGroup({
      ...
      requestedAmount: new FormControl({ value: editObj.requestedAmount,disabled: viewMode }, [Validators.required,Validators.max(9999999999999)]),
      remarks: new FormControl({ value: editObj.remarks,disabled: viewMode },[Validators.maxLength(80)]),
