...
@Component({
  selector: 'app-periodic-medical',
  templateUrl: './periodic-medical.component.html',
  styleUrls: ['./periodic-medical.component.css'],
})
export class PeriodicMedicalComponent implements OnInit {
  form: FormArray;
