...
export const ViewEditDependentsColumnsValues = {
  position: 'No.',
  name: 'Name',
...
export class GHPDetailModel {
  planId: string;
  benifitPlanId: string;
  optionId: string;
  coverageId: string;
  benCostRuleId: string;
  options: string;
  coverage: string;
  insuranceDebits: number;
  selected: boolean;
}
...
export class RelativeViewDatasourceModel {
  relationship: string;
  relativeName: string;
}
